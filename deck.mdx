...
Select -> elem
5 [style="filled", fontcolor="#b36232"]
Apply -> Select [color="#ef4b4b", fontcolor="#ef4b4b", label="?(...)", fontsize="24"];
Apply -> Literal
Literal -> 5
}
`,
...
Ident -> foo
elem [label="\\\"elem\\\"", style="filled", fontcolor="#b36232"]
Select -> Ident [color="#ef4b4b", fontcolor="#ef4b4b", label="?.elem", fontsize="24"];
Select -> elem
5 [style="filled", fontcolor="#b36232"]
Apply -> Select [color="#ef4b4b", fontcolor="#ef4b4b", label="?(...)", fontsize="24"];
Apply -> Literal
...
Select -> elem
5 [style="filled", fontcolor="#b36232"]
Apply -> Select [color="#ef4b4b", fontcolor="#ef4b4b", label="?(Int)", fontsize="24"];
Apply -> Literal;
Literal -> 5
}
`,
...
<center>
<span style="font-family: Fira Mono; background-color: #e4f6bd;">¯\_(ツ)_/¯</span>
</center>
</li>
</Appear>
</ol>
...
<table class="fragment" data-fragment-index="3" style="width: 80%;">
<tr>
<td><b>Where</b> does T appear in <span style="font-family: Fira Mono;">ResType</span> ?</td>
<td>Instantiation of <span style="color: #00a2b3;">T?</span></td>
</tr>
<tr>
<td>Nowhere</td>
<td>
<Appear>
<span>
<span style="font-family: Fira Mono;">Lo</span> (arbitrary)
</span>
</Appear>
</td>
</tr>
<tr>
<td>In <b>co</b>variant position</td>
<td>
<Appear>
<span></span>
<span>
<span style="font-family: Fira Mono;">Lo</span>
</span>
</Appear>
</td>
</tr>
<tr>
<td>In <b>contra</b>variant position</td>
<td>
<Appear>
<span></span>
<span></span>
<span>
<span style="font-family: Fira Mono;">Hi</span>
</span>
</Appear>
</td>
</tr>
<tr>
<td>In <b>co</b>- <b>and</b> <b>contra</b>variant<br/> or <b>in</b>variant position</td>
<td>
<Appear>
<span></span>
<span></span>
<span></span>
<span>
<b>Unsafe: delay instantiation</b>
</span>
</Appear>
</td>
</tr>
...
<li>… and a few other cases</li>
</Appear>
</ul>

---

# Forced instantiation example
...
<ol>
<Appear>
<li><span style="font-family: Fira Mono;">id[T?](Foo[A?](1))</span></li>
<li><span style="font-family: Fira Mono;">A? &gt;: Int</span></li>
<li><span style="font-family: Fira Mono;">Foo[A?] &lt;: Foo[T?]</span></li>
<li><span style="font-family: Fira Mono;">T? =: A?</span></li>
<li>To type <span style="font-family: Fira Mono;">f</span>, we need to force <span style="font-family: Fira Mono;">?A</span></li>
<li><span style="font-family: Fira Mono;">A? =: Int</span></li>
</Appear>
</ol>
...
# Forced <span style="color: #930077;">instantiation</span> heuristic

<ol>
<li>
if a <span
style="color:#00a2b3;">type variable</span> is <span style="color: #ff80ae;">constrained</span> in only one direction,<br/>
use that <span style="color: #ff80ae;">constraint</span> as the <span style="color: #930077;">instantiation</span></li>
<li>Otherwise, use the <span style="color: #ff80ae;">lower bound constraint</span></li>
</ol>
...
<li>… unless the instantiated type would be <span style="font-family: Fira Mono;">Nothing</span></li>
...
# The fear of <span style="font-family: Fira Mono;">Nothing</span> 😱

- Sometimes you really want to infer <span style="font-family: Fira Mono;">Nothing</span>, but Scala 2 won't let you!
  ```scala
  class Foo[T]
  def foo[T](x: Foo[T]) = x
...
```scala
def foo[T](x: T)(implicit ev: Foo[T]): …
```
<br/>
<span style="font-family: Fira Mono;">foo<span style="color:
#91b029;">[</span><span style="color: #00a2b3;">T?</span><span style="color:
...
Should we <b>force</b> the <span style="color: #930077;">instantiation</span> of <span style="font-family: Fira Mono; color: #00a2b3;">T?</span> <b>before</b> doing the implicit search ?

---

# Attempt 1: Don't force anything

```scala
def foo[T](x: T)(implicit ev: Foo[T]): …

implicit val a: Foo[Int] = …
implicit val b: Foo[Any] = …
```
<br/>
<span style="font-family: Fira Mono;">foo<span style="color:
#91b029;">[</span><span style="color: #00a2b3;">T?</span><span style="color:
...
<Appear>
<li>
<span style="font-family: Fira Mono;">
<span style="color: #00a2b3;">T?</span> <span style="color: #ff80ae;">&gt;: Int</span>
</span>
</li>
<li>
Both <span style="font-family: Fira Mono;">a</span> and <span style="font-family: Fira Mono;">b</span> match the type: ambiguous implicits!
</li>
</Appear>
</ul>
...
# Attempt 2: Force all type variables
...
implicit object mmm extends Mult[Matrix, Matrix, Matrix] {
  def apply(a: Matrix, b: Matrix): Matrix = …
}
implicit object mvv extends Mult[Matrix, Vector, Vector] {
  def apply(a: Matrix, b: Vector): Vector = …
}
```
...
def mult[A, B, C](a: A, b: B)(
  implicit ev: Mult[A, B, C]): C = ev(a, b)
...
<li>
<span style="font-family: Fira Mono;">
mult<span style="color:
#91b029;">[</span><span style="color:#00a2b3;">?A</span>, <span style="color:#00a2b3;">?B</span>, <span style="color:#00a2b3;">?C</span><span style="color:
#91b029;">]</span>(matrix1, vector1)
</span>
</li>
<li>
<span style="font-family: Fira Mono;">
<span style="color:#00a2b3;">?A</span> <span style="color: #ff80ae;">&gt;: Matrix</span>
</span>
</li>
<li>
<span style="font-family: Fira Mono;">
<span style="color:#00a2b3;">?B</span> <span style="color: #ff80ae;">&gt;: Vector</span>
</span>
</li>
<li>
<span style="font-family: Fira Mono;">
<span style="color:#00a2b3;">?C</span> unconstrained (<span style="color: #ff80ae;">&gt;: Nothing &lt;: Any</span>)
</span>
</li>
<li>Implicit search for <span style="font-family: Fira Mono;">Mult[<span
style="color:#00a2b3;">?A</span>, <span style="color:#00a2b3;">?B</span>, <span
style="color:#00a2b3;">?C</span>]</span></li>
<li><span style="color: #930077;">Instantiate</span> all variables: <br/><span style="font-family: Fira Mono; color: #930077;">Mult[Matrix, Vector, Nothing]</span>
</li>
<li>Implicit not found! 🤦</li>
</Appear>
</ul>
...
<Appear>
<li>
We should only instantiate <b style="color: #ff80ae;">constrained</b> <span style="color:#00a2b3;">type variables</span>!
</li>
<li>
mult<span style="color:
#91b029;">[</span><span style="color:#00a2b3;">?A</span>, <span style="color:#00a2b3;">?B</span>, <span style="color:#00a2b3;">?C</span><span style="color:
...
<li>Implicit search for <br/><span style="font-family: Fira Mono; color: #930077;">Mult[Matrix, Vector, <span style="color:#00a2b3;">?C</span>]</span>
</li>
<li>
<span style="font-family: Fira Mono;">
mvv &lt;: Mult[Matrix, Vector, <span style="color:#00a2b3;">?C</span>]
</span>
</li>
<li>
<span style="font-family: Fira Mono;">
Mult[Matrix, Vector, Vector] &lt;: <br/>Mult[Matrix, Vector, <span style="color:#00a2b3;">?C</span>]
</span>
</li>
<li>
<span style="font-family: Fira Mono;">
<span
style="color:#00a2b3;">C?</span> <span style="color: #930077;">:=
Vector</span>
</span>
</li>
<li>No other matching implicit: success!</li>
</Appear>
</ul>
...
- This is a form of <b>higher-order unification</b>
...
```
This is <b>infinite</b> and need to be approximated, in Dotty instead we have `C | D`.
...
- Solution: <b>widen</b> the type to a non-union.
...
- Open issue: https://github.com/lampepfl/dotty/issues/4867
